...
public class EndernylumBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endernylum")
	public static final Block block = null;
	public EndernylumBlock(BetterEndModElements instance) {
		super(instance, 56);
	}
