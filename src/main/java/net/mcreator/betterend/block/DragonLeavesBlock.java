...
public class DragonLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_leaves")
	public static final Block block = null;
	public DragonLeavesBlock(BetterEndModElements instance) {
		super(instance, 129);
	}
