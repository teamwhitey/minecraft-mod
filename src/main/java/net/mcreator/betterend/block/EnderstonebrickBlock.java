...
public class EnderstonebrickBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderstonebrick")
	public static final Block block = null;
	public EnderstonebrickBlock(BetterEndModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("enderstonebrick");
		}
