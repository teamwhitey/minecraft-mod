...
public class GreenStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_stairs")
	public static final Block block = null;
	public GreenStairsBlock(BetterEndModElements instance) {
		super(instance, 390);
	}
