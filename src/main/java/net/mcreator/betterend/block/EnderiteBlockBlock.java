...
public class EnderiteBlockBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderite_block")
	public static final Block block = null;
	public EnderiteBlockBlock(BetterEndModElements instance) {
		super(instance, 3);
	}
