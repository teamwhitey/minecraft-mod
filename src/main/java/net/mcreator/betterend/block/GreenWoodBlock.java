...
public class GreenWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_wood")
	public static final Block block = null;
	public GreenWoodBlock(BetterEndModElements instance) {
		super(instance, 386);
	}
