...
public class SunLogBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_log")
	public static final Block block = null;
	public SunLogBlock(BetterEndModElements instance) {
		super(instance, 194);
	}
