...
public class SunPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_planks")
	public static final Block block = null;
	public SunPlanksBlock(BetterEndModElements instance) {
		super(instance, 195);
	}
