...
public class SunSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_slab")
	public static final Block block = null;
	public SunSlabBlock(BetterEndModElements instance) {
		super(instance, 198);
	}
