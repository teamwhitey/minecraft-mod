...
public class MagucnylumBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magucnylum")
	public static final Block block = null;
	public MagucnylumBlock(BetterEndModElements instance) {
		super(instance, 77);
	}
