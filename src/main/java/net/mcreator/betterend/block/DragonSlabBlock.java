...
public class DragonSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_slab")
	public static final Block block = null;
	public DragonSlabBlock(BetterEndModElements instance) {
		super(instance, 131);
	}
