...
public class WaterFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_fence_gate")
	public static final Block block = null;
	public WaterFenceGateBlock(BetterEndModElements instance) {
		super(instance, 230);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("water_fence_gate");
		}
