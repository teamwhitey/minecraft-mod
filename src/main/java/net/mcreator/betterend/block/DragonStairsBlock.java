...
public class DragonStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_stairs")
	public static final Block block = null;
	public DragonStairsBlock(BetterEndModElements instance) {
		super(instance, 130);
	}
