...
public class GreenButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_button")
	public static final Block block = null;
	public GreenButtonBlock(BetterEndModElements instance) {
		super(instance, 395);
	}
