...
public class MagicFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_fence")
	public static final Block block = null;
	public MagicFenceBlock(BetterEndModElements instance) {
		super(instance, 63);
	}
