...
public class MagicLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_leaves")
	public static final Block block = null;
	public MagicLeavesBlock(BetterEndModElements instance) {
		super(instance, 60);
	}
