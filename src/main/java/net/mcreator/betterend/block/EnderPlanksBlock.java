...
public class EnderPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_planks")
	public static final Block block = null;
	public EnderPlanksBlock(BetterEndModElements instance) {
		super(instance, 33);
	}
