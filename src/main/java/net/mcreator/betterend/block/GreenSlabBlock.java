...
public class GreenSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_slab")
	public static final Block block = null;
	public GreenSlabBlock(BetterEndModElements instance) {
		super(instance, 391);
	}
