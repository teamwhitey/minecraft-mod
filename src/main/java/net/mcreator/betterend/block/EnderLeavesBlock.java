...
public class EnderLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_leaves")
	public static final Block block = null;
	public EnderLeavesBlock(BetterEndModElements instance) {
		super(instance, 34);
	}
