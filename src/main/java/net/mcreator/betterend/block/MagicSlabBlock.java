...
public class MagicSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_slab")
	public static final Block block = null;
	public MagicSlabBlock(BetterEndModElements instance) {
		super(instance, 62);
	}
