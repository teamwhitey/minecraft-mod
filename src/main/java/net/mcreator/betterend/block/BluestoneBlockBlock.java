...
public class BluestoneBlockBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:bluestone_block")
	public static final Block block = null;
	public BluestoneBlockBlock(BetterEndModElements instance) {
		super(instance, 381);
	}
