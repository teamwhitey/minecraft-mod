...
public class EndercaneBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endercane")
	public static final Block block = null;
	public EndercaneBlock(BetterEndModElements instance) {
		super(instance, 215);
	}
