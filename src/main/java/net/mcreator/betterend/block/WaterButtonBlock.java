...
public class WaterButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_button")
	public static final Block block = null;
	public WaterButtonBlock(BetterEndModElements instance) {
		super(instance, 232);
	}
