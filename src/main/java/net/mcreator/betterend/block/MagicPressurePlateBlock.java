...
public class MagicPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_pressure_plate")
	public static final Block block = null;
	public MagicPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("magic_pressure_plate");
		}
