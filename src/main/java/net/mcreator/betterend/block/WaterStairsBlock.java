...
public class WaterStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_stairs")
	public static final Block block = null;
	public WaterStairsBlock(BetterEndModElements instance) {
		super(instance, 227);
	}
