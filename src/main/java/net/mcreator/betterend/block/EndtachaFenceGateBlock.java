...
public class EndtachaFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_fence_gate")
	public static final Block block = null;
	public EndtachaFenceGateBlock(BetterEndModElements instance) {
		super(instance, 263);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_fence_gate");
		}
