...
public class MagicButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_button")
	public static final Block block = null;
	public MagicButtonBlock(BetterEndModElements instance) {
		super(instance, 66);
	}
