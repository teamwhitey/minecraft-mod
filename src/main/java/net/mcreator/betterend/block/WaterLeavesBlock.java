...
public class WaterLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_leaves")
	public static final Block block = null;
	public WaterLeavesBlock(BetterEndModElements instance) {
		super(instance, 226);
	}
