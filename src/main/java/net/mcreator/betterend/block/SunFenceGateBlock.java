...
public class SunFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_fence_gate")
	public static final Block block = null;
	public SunFenceGateBlock(BetterEndModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("sun_fence_gate");
		}
