...
public class EndtachaLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_leaves")
	public static final Block block = null;
	public EndtachaLeavesBlock(BetterEndModElements instance) {
		super(instance, 259);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_leaves");
		}
