...
public class MagicWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_wood")
	public static final Block block = null;
	public MagicWoodBlock(BetterEndModElements instance) {
		super(instance, 57);
	}
