...
public class MagicPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_planks")
	public static final Block block = null;
	public MagicPlanksBlock(BetterEndModElements instance) {
		super(instance, 59);
	}
