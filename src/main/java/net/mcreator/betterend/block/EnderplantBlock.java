...
public class EnderplantBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderplant")
	public static final Block block = null;
	public EnderplantBlock(BetterEndModElements instance) {
		super(instance, 151);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_end:enderplant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == EndernylumBlock.block);
		}
