...
public class GreennylimBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:greennylim")
	public static final Block block = null;
	public GreennylimBlock(BetterEndModElements instance) {
		super(instance, 385);
	}
