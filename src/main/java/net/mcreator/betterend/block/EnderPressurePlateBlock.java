...
public class EnderPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_pressure_plate")
	public static final Block block = null;
	public EnderPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("ender_pressure_plate");
		}
