...
public class DragonButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_button")
	public static final Block block = null;
	public DragonButtonBlock(BetterEndModElements instance) {
		super(instance, 135);
	}
