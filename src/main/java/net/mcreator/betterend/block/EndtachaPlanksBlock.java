...
public class EndtachaPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_planks")
	public static final Block block = null;
	public EndtachaPlanksBlock(BetterEndModElements instance) {
		super(instance, 258);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("endtacha_planks");
		}
