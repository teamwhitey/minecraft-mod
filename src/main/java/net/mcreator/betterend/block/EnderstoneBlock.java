...
public class EnderstoneBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderstone")
	public static final Block block = null;
	public EnderstoneBlock(BetterEndModElements instance) {
		super(instance, 125);
	}
