...
public class WaterWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_wood")
	public static final Block block = null;
	public WaterWoodBlock(BetterEndModElements instance) {
		super(instance, 223);
	}
