...
import net.mcreator.betterend.procedures.AplyhuantedProcedure;
...
public class DragonfernBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragonfern")
	public static final Block block = null;
	public DragonfernBlock(BetterEndModElements instance) {
		super(instance, 153);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dragonfern"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_end:dragonfern"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				AplyhuantedProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
