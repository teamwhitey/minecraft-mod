...
public class EndtachaSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_slab")
	public static final Block block = null;
	public EndtachaSlabBlock(BetterEndModElements instance) {
		super(instance, 261);
	}
