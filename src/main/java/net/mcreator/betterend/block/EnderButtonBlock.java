...
public class EnderButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_button")
	public static final Block block = null;
	public EnderButtonBlock(BetterEndModElements instance) {
		super(instance, 40);
	}
