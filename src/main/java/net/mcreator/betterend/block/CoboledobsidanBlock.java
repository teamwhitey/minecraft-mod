...
public class CoboledobsidanBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:coboledobsidan")
	public static final Block block = null;
	public CoboledobsidanBlock(BetterEndModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("coboledobsidan");
		}
