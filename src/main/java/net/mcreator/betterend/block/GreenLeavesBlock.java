...
public class GreenLeavesBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_leaves")
	public static final Block block = null;
	public GreenLeavesBlock(BetterEndModElements instance) {
		super(instance, 389);
	}
