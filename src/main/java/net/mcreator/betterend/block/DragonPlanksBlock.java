...
public class DragonPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_planks")
	public static final Block block = null;
	public DragonPlanksBlock(BetterEndModElements instance) {
		super(instance, 128);
	}
