...
public class EndtachaPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_pressure_plate")
	public static final Block block = null;
	public EndtachaPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 264);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_pressure_plate");
		}
