...
public class EndtachaButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_button")
	public static final Block block = null;
	public EndtachaButtonBlock(BetterEndModElements instance) {
		super(instance, 265);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_button");
		}
