...
public class ObsidaniteblockBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:obsidaniteblock")
	public static final Block block = null;
	public ObsidaniteblockBlock(BetterEndModElements instance) {
		super(instance, 349);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("obsidaniteblock");
		}
