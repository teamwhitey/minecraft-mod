...
public class SunWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_wood")
	public static final Block block = null;
	public SunWoodBlock(BetterEndModElements instance) {
		super(instance, 193);
	}
