...
public class DragonFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_fence")
	public static final Block block = null;
	public DragonFenceBlock(BetterEndModElements instance) {
		super(instance, 132);
	}
