...
public class WaterSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_slab")
	public static final Block block = null;
	public WaterSlabBlock(BetterEndModElements instance) {
		super(instance, 228);
	}
