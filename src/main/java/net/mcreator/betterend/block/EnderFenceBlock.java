...
public class EnderFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_fence")
	public static final Block block = null;
	public EnderFenceBlock(BetterEndModElements instance) {
		super(instance, 37);
	}
