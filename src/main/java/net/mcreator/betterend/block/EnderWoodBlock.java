...
public class EnderWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_wood")
	public static final Block block = null;
	public EnderWoodBlock(BetterEndModElements instance) {
		super(instance, 31);
	}
