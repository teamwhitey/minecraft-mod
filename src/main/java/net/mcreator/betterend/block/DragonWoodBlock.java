...
public class DragonWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_wood")
	public static final Block block = null;
	public DragonWoodBlock(BetterEndModElements instance) {
		super(instance, 126);
	}
