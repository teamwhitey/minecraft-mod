...
public class MagicFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:magic_fence_gate")
	public static final Block block = null;
	public MagicFenceGateBlock(BetterEndModElements instance) {
		super(instance, 64);
	}
