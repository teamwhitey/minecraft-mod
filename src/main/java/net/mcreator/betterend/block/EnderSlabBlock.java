...
public class EnderSlabBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_slab")
	public static final Block block = null;
	public EnderSlabBlock(BetterEndModElements instance) {
		super(instance, 36);
	}
