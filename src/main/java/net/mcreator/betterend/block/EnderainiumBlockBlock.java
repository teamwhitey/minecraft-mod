...
public class EnderainiumBlockBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium_block")
	public static final Block block = null;
	public EnderainiumBlockBlock(BetterEndModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("enderainium_block");
		}
