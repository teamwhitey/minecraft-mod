...
public class EndtachaWoodBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_wood")
	public static final Block block = null;
	public EndtachaWoodBlock(BetterEndModElements instance) {
		super(instance, 256);
	}
