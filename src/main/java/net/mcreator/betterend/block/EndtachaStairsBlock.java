...
public class EndtachaStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_stairs")
	public static final Block block = null;
	public EndtachaStairsBlock(BetterEndModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_stairs");
		}
