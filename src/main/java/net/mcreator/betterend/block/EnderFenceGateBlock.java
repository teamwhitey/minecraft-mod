...
public class EnderFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_fence_gate")
	public static final Block block = null;
	public EnderFenceGateBlock(BetterEndModElements instance) {
		super(instance, 38);
	}
