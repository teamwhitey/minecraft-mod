...
public class DragonPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_pressure_plate")
	public static final Block block = null;
	public DragonPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_pressure_plate");
		}
