...
public class GreenLogBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_log")
	public static final Block block = null;
	public GreenLogBlock(BetterEndModElements instance) {
		super(instance, 387);
	}
