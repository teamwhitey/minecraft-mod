...
public class DragonFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_fence_gate")
	public static final Block block = null;
	public DragonFenceGateBlock(BetterEndModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dragon_fence_gate");
		}
