...
public class SunnylumBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sunnylum")
	public static final Block block = null;
	public SunnylumBlock(BetterEndModElements instance) {
		super(instance, 192);
	}
