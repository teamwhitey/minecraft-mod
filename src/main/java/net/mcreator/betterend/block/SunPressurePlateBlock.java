...
public class SunPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_pressure_plate")
	public static final Block block = null;
	public SunPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("sun_pressure_plate");
		}
