...
public class SunStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_stairs")
	public static final Block block = null;
	public SunStairsBlock(BetterEndModElements instance) {
		super(instance, 197);
	}
