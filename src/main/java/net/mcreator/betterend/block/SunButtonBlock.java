...
public class SunButtonBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_button")
	public static final Block block = null;
	public SunButtonBlock(BetterEndModElements instance) {
		super(instance, 202);
	}
