...
public class WaterFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_fence")
	public static final Block block = null;
	public WaterFenceBlock(BetterEndModElements instance) {
		super(instance, 229);
	}
