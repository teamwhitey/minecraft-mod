...
public class EnderStairsBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:ender_stairs")
	public static final Block block = null;
	public EnderStairsBlock(BetterEndModElements instance) {
		super(instance, 35);
	}
