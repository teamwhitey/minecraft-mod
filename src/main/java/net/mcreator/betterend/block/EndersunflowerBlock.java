...
public class EndersunflowerBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endersunflower")
	public static final Block block = null;
	public EndersunflowerBlock(BetterEndModElements instance) {
		super(instance, 214);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("endersunflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("better_end:endersunflower"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("endersunflower");
		}
