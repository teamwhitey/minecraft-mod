...
public class GreenFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_fence")
	public static final Block block = null;
	public GreenFenceBlock(BetterEndModElements instance) {
		super(instance, 392);
	}
