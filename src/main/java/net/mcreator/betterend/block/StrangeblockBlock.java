...
public class StrangeblockBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:strangeblock")
	public static final Block block = null;
	@ObjectHolder("better_end:strangeblock")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public StrangeblockBlock(BetterEndModElements instance) {
		super(instance, 53);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("strangeblock"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("strangeblock");
		}
