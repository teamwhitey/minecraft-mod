...
public class SunFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:sun_fence")
	public static final Block block = null;
	public SunFenceBlock(BetterEndModElements instance) {
		super(instance, 199);
	}
