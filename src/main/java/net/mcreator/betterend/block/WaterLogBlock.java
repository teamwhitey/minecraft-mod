...
public class WaterLogBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_log")
	public static final Block block = null;
	public WaterLogBlock(BetterEndModElements instance) {
		super(instance, 224);
	}
