...
public class EndtachaLogBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_log")
	public static final Block block = null;
	public EndtachaLogBlock(BetterEndModElements instance) {
		super(instance, 257);
	}
