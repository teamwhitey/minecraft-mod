...
public class EnderbricksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderbricks")
	public static final Block block = null;
	public EnderbricksBlock(BetterEndModElements instance) {
		super(instance, 168);
	}
