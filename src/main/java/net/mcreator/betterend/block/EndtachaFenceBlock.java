...
public class EndtachaFenceBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtacha_fence")
	public static final Block block = null;
	public EndtachaFenceBlock(BetterEndModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("endtacha_fence");
		}
