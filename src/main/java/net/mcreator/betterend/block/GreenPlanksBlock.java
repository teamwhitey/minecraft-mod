...
public class GreenPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_planks")
	public static final Block block = null;
	public GreenPlanksBlock(BetterEndModElements instance) {
		super(instance, 388);
	}
