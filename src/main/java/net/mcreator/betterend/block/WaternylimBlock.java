...
public class WaternylimBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:waternylim")
	public static final Block block = null;
	public WaternylimBlock(BetterEndModElements instance) {
		super(instance, 243);
	}
