...
public class WaterPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_pressure_plate")
	public static final Block block = null;
	public WaterPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 231);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("water_pressure_plate");
		}
