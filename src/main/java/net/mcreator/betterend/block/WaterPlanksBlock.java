...
public class WaterPlanksBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:water_planks")
	public static final Block block = null;
	public WaterPlanksBlock(BetterEndModElements instance) {
		super(instance, 225);
	}
