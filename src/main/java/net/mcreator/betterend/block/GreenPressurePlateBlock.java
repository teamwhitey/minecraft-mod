...
public class GreenPressurePlateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_pressure_plate")
	public static final Block block = null;
	public GreenPressurePlateBlock(BetterEndModElements instance) {
		super(instance, 394);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("green_pressure_plate");
		}
