...
public class DragonLogBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragon_log")
	public static final Block block = null;
	public DragonLogBlock(BetterEndModElements instance) {
		super(instance, 127);
	}
