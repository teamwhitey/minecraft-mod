...
public class EndtatchanylimBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:endtatchanylim")
	public static final Block block = null;
	public EndtatchanylimBlock(BetterEndModElements instance) {
		super(instance, 374);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("endtatchanylim");
		}
