...
public class GreenFenceGateBlock extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:green_fence_gate")
	public static final Block block = null;
	public GreenFenceGateBlock(BetterEndModElements instance) {
		super(instance, 393);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("green_fence_gate");
		}
