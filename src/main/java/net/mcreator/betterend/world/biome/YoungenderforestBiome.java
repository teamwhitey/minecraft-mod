...
public class YoungenderforestBiome extends BetterEndModElements.ModElement {
	public static Biome biome;
	public YoungenderforestBiome(BetterEndModElements instance) {
		super(instance, 369);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("better_end:youngenderforest"));
			}
		}
	}
	@Override
