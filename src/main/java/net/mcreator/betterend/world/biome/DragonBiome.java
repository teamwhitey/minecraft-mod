...
public class DragonBiome extends BetterEndModElements.ModElement {
	public static Biome biome;
	public DragonBiome(BetterEndModElements instance) {
		super(instance, 146);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("better_end:dragon"));
			}
		}
	}
	@Override
