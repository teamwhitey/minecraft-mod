...
import net.mcreator.betterend.block.MagucnylumBlock;
import net.mcreator.betterend.block.MagicLogBlock;
import net.mcreator.betterend.block.MagicLeavesBlock;
...
public class MagicforestBiome extends BetterEndModElements.ModElement {
	public static Biome biome;
	public MagicforestBiome(BetterEndModElements instance) {
		super(instance, 78);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-16737895).withGrassColor(9470285).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(MagucnylumBlock.block.getDefaultState(),
								EnderstoneBlock.block.getDefaultState(), EnderstoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MagicLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(MagicLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("better_end:magicforest"));
			}
		}
	}
	@Override
