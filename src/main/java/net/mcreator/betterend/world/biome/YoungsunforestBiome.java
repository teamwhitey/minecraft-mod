...
public class YoungsunforestBiome extends BetterEndModElements.ModElement {
	public static Biome biome;
	public YoungsunforestBiome(BetterEndModElements instance) {
		super(instance, 372);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("better_end:youngsunforest"));
			}
		}
	}
	@Override
