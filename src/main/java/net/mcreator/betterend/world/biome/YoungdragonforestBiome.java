...
import net.mcreator.betterend.block.DragonLogBlock;
import net.mcreator.betterend.block.DragonLeavesBlock;
import net.mcreator.betterend.BetterEndModElements;

@BetterEndModElements.ModElement.Tag
public class YoungdragonforestBiome extends BetterEndModElements.ModElement {
	public static Biome biome;
	public YoungdragonforestBiome(BetterEndModElements instance) {
		super(instance, 371);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(DragonnylimBlock.block.getDefaultState(),
								EnderstoneBlock.block.getDefaultState(), EnderstoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(DragonLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(DragonLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("better_end:youngdragonforest"));
			}
		}
	}
	@Override
