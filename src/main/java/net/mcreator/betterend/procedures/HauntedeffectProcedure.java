...
public class HauntedeffectProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BetterEndMod.LOGGER.warn("Failed to load dependency x for procedure Hauntedeffect!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BetterEndMod.LOGGER.warn("Failed to load dependency y for procedure Hauntedeffect!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BetterEndMod.LOGGER.warn("Failed to load dependency z for procedure Hauntedeffect!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BetterEndMod.LOGGER.warn("Failed to load dependency world for procedure Hauntedeffect!");
			return;
		}
						...
						|| (((((world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 1), (int) z))).getBlock() == EnderstoneBlock.block)
								...
								|| ((((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) (z + 1)))).getBlock() == EnderstoneBlock.block)
										...
										|| (((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) (z + 1))))
												...
												|| ((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) (z - 1))))
														.getBlock() == EnderstoneBlock.block))))))) {
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), EndernylumBlock.block.getDefaultState(), 3);
		}
	}
}
