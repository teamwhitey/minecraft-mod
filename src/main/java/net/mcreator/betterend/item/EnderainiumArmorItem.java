...
public class EnderainiumArmorItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("better_end:enderainium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("better_end:enderainium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("better_end:enderainium_armor_boots")
	public static final Item boots = null;
	public EnderainiumArmorItem(BetterEndModElements instance) {
		super(instance, 105);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(BetterendstuffItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "better_end:textures/models/armor/enderainium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("enderainium_armor_helmet"));
		...
		}.setRegistryName("enderainium_armor_chestplate"));
		...
		}.setRegistryName("enderainium_armor_leggings"));
		...
		}.setRegistryName("enderainium_armor_boots"));
	}
}
