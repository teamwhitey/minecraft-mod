...
public class WhitePickaxeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:white_pickaxe")
	public static final Item block = null;
	public WhitePickaxeItem(BetterEndModElements instance) {
		super(instance, 181);
	}
