...
public class EnderainiumItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium")
	public static final Item block = null;
	public EnderainiumItem(BetterEndModElements instance) {
		super(instance, 89);
	}
