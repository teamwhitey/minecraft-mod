...
public class Reinforced_enderiteArmorItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:reinforced_enderite_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("better_end:reinforced_enderite_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("better_end:reinforced_enderite_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("better_end:reinforced_enderite_armor_boots")
	public static final Item boots = null;
	public Reinforced_enderiteArmorItem(BetterEndModElements instance) {
		super(instance, 336);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "reinforced_enderite_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(BetterendstuffItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "better_end:textures/models/armor/reinforced_enderite_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("reinforced_enderite_armor_helmet"));
		...
		}.setRegistryName("reinforced_enderite_armor_chestplate"));
		...
		}.setRegistryName("reinforced_enderite_armor_leggings"));
		...
		}.setRegistryName("reinforced_enderite_armor_boots"));
	}
}
