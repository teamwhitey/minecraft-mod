...
public class RainbowshardItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:rainbowshard")
	public static final Item block = null;
	public RainbowshardItem(BetterEndModElements instance) {
		super(instance, 351);
	}
