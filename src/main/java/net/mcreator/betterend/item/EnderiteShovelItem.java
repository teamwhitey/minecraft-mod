...
public class EnderiteShovelItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderite_shovel")
	public static final Item block = null;
	public EnderiteShovelItem(BetterEndModElements instance) {
		super(instance, 10);
	}
