...
public class EnderainiumAxeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium_axe")
	public static final Item block = null;
	public EnderainiumAxeItem(BetterEndModElements instance) {
		super(instance, 96);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("enderainium_axe"));
	}
}
