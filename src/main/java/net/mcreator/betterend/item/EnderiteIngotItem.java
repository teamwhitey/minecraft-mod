...
public class EnderiteIngotItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderite_ingot")
	public static final Item block = null;
	public EnderiteIngotItem(BetterEndModElements instance) {
		super(instance, 1);
	}
