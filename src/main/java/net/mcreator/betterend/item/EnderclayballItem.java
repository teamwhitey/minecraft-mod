...
public class EnderclayballItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderclayball")
	public static final Item block = null;
	public EnderclayballItem(BetterEndModElements instance) {
		super(instance, 342);
	}
