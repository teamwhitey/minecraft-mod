...
public class ObsidaniteingotItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:obsidaniteingot")
	public static final Item block = null;
	public ObsidaniteingotItem(BetterEndModElements instance) {
		super(instance, 303);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("obsidaniteingot");
		}
