...
public class DragonchargeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:dragoncharge")
	public static final Item block = null;
	public DragonchargeItem(BetterEndModElements instance) {
		super(instance, 178);
	}
