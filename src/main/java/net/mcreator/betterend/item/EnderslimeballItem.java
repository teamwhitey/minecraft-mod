...
public class EnderslimeballItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderslimeball")
	public static final Item block = null;
	public EnderslimeballItem(BetterEndModElements instance) {
		super(instance, 161);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("enderslimeball");
		}
