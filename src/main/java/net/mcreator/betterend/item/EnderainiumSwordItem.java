...
public class EnderainiumSwordItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium_sword")
	public static final Item block = null;
	public EnderainiumSwordItem(BetterEndModElements instance) {
		super(instance, 97);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("enderainium_sword"));
	}
}
