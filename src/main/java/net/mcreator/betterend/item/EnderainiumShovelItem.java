...
public class EnderainiumShovelItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderainium_shovel")
	public static final Item block = null;
	public EnderainiumShovelItem(BetterEndModElements instance) {
		super(instance, 98);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("enderainium_shovel"));
	}
}
