...
public class EnderiteHoeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderite_hoe")
	public static final Item block = null;
	public EnderiteHoeItem(BetterEndModElements instance) {
		super(instance, 11);
	}
