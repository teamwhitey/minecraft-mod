...
public class EnderlandsPickaxeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderlands_pickaxe")
	public static final Item block = null;
	public EnderlandsPickaxeItem(BetterEndModElements instance) {
		super(instance, 286);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("enderlands_pickaxe"));
	}
}
