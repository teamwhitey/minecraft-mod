...
public class EnderiteAxeItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:enderite_axe")
	public static final Item block = null;
	public EnderiteAxeItem(BetterEndModElements instance) {
		super(instance, 8);
	}
