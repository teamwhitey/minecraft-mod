...
public class RedgemItem extends BetterEndModElements.ModElement {
	@ObjectHolder("better_end:redgem")
	public static final Item block = null;
	public RedgemItem(BetterEndModElements instance) {
		super(instance, 302);
	}
